    ...
    <section className="py-24 relative z-10 border-t border-emerald-900/20 bg-black/40">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          <p className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-3">Resiliência e Comando</p>
          <h2 className="text-4xl font-black text-white mb-4">Perguntas <span className="gradient-text">Frequentes.</span></h2>
          <p className="text-slate-400 max-w-xl mx-auto">
            Esclarecimentos técnicos sobre como o Certus Engine impõe a soberania e o determinismo no ecossistema de IA.
          </p>
        </div>

        <div className="space-y-4">
          {FAQ_ITEMS.slice(0, 8).map((item, idx) => ( // Show first 8 on homepage for brevity
            <div 
              key={idx}
