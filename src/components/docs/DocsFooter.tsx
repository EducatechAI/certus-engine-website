  ...
  return (
    <footer className="mt-16 pt-8 border-t border-emerald-900/30 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-mono text-slate-500">
      <div className="space-y-1 text-center md:text-left">
        <p>Última atualização: <span className="text-slate-300">2026-09-11</span></p>
        ...
        <p>Nível aplicável: <span className="text-emerald-400">[conforme seção]</span></p>
        <p><Link href="/pricing" className="text-emerald-500 hover:underline">Ver níveis de produto &rarr;</Link></p>
      </div>
